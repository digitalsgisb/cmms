const CACHE_NAME = "sugi-cmms-shell-v13";
const APP_SHELL_URL = "/";
const SHELL_ASSETS = [APP_SHELL_URL, "/manifest.webmanifest", "/requester.webmanifest", "/icons/cmms-icon.svg", "/brand/sugi_logo.png", "/brand/sugi_logo_white.png"];
